...
func New(dir string) *boli.App {
	var (
		db       = tmdb.NewMemDB()
		logger   = log.NewNopLogger()
		encoding = boli.MakeEncodingConfig()
	)

	a := boli.New(logger, db, nil, true, map[int64]bool{}, dir, 0, encoding,
		simapp.EmptyAppOptions{}, boli.GetWasmEnabledProposals(), boli.EmptyWasmOpts)
